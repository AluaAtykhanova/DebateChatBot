...
export const prompts = {
    ...
    "Причём тут Белка? В Алматинскомм Дебатном сообществе уже дажно существует термин Белка что обозначает аргумент который не несёт серьёзного смысла и содержания, он скорее всего построен на абсурде и игроки его вводят чтобы немного выйти из рамок дебат и получить веселье от игры неся абсолютный бред" +
